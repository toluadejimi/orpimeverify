...
Route::group(['middleware' => ['auth', 'user', 'session.timeout', 'single_session']], function () {
    ...
    Route::get('/verify/flutterwave', [HomeController::class, 'verifyFlutterwave'])->name('fund.verifyflutterwave');
    Route::get('/verify/getpay', [HomeController::class, 'verifyGetPay'])->name('fund.getpay');
