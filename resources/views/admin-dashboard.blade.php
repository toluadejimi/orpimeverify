                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="https://oprimeverify.com/admin-dashboard"><i class="fa fa-fw fa-user-circle"></i>Dashboard <span class="badge badge-success">6</span></a>
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="https://oprimeverify.com/admin-dashboard" class="breadcrumb-link">Dashboard</a></li>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Update Cost / Rate For Server 2</h5>
                                    <div class="card-body p-0">


                                        <div class="col-12 p-3">

                                        <form method="post" action="update-rate2">
                                        @csrf
                                        <label>RATE</label>
                                        <input class="form-control2 text-dark" name="rate" value="{{ $usdtongn2 }}">
                                        ...
                                        <div class="col-12 p-3">
                                        <form method="post" action="update-cost2">
                                        @csrf
                                        <label>COST</label>
                                        <input class="form-control2 text-dark" name="cost" value="{{ $margin2 }}">
                            ...
                            <div class="card">
                                <h5 class="card-header">Update Cost / Rate For Server 3</h5>
                                <div class="card-body p-0">


                                    <div class="col-12 p-3">

                                        <form method="post" action="update-rate3">
                                            @csrf
                                            <label>RATE</label>
                                            <input class="form-control2 text-dark" name="rate" value="{{ $usdtongn3 }}">
                                    ...
                                    <div class="col-12 p-3">
                                        <form method="post" action="update-cost3">
                                            @csrf
                                            <label>COST</label>
                                            <input class="form-control2 text-dark" name="cost" value="{{ $margin3 }}">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        Copyright © 2018 OPrime verify. All rights reserved. Dashboard by <a href="https://colorlib.com/wp/">Colorlib</a>.
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
