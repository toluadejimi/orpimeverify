...
<div class="container ">
    ...
    <div class="d-flex justify-content-center mb-3 p-1">
        ...
        <h4 style="color: ">If you use WhatsApp business u are on ur own ooo nah 50/50 chance of getting banned ❌ </h4> <br>
...
<!--</center>-->
 ...
 <!--   <div class="row mt-5">-->
 <br>
<iframe width="400" height="315" src="https://www.youtube.com/embed/d_TbY-_EuiM?si=Dp57PAS972qQzHqP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<br>
            ...
            <div class="card border-0 shadow-lg p-2 mb-3 bg-body rounded-40">
                <div class="card-body">
                    <div class="">
                        ...
                        <div class="row my-3 p-2" style="background: #000000; border-radius: 10px; color: white; font-size: 15px; border-radius: 18px">
                            <div class="col-7">
                                <h5>Services</h5>
                            </div>
                            <div class="col">
...
<div @click="currentTab = 1" class="button-gradient bg-gradient-to-r from-black to-black text-white text-sm font-medium me-2 px-4 py-2 rounded-md hover:cursor-pointer">
    USA 🇺🇸 Numbers (1)
</div>
<div @click="currentTab = 2" class="button-gradient bg-gradient-to-r from-black to-black text-white text-sm font-medium me-2 px-4 py-2 rounded-md hover:cursor-pointer">
    USA 🇺🇸 Numbers 2
</div>
<div @click="currentTab = 3" class="button-gradient bg-gradient-to-r from-black to-black text-white text-sm font-medium me-2 px-4 py-2 rounded-md hover:cursor-pointer">
    All Country Numbers
</div>
