...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="/">OPRIME VERIFY</a>
                ...
                <div class="ecommerce-widget">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <label>Pin</label>
                                                        <input type="password" class="form-control2 text-dark" name="pin"
                                                               required>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <h3 class="p-3">Set Custom Price for user</h3>


                            <form action="/update-user_custom" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <div class="card-body p-3">
                                            <label>Enter Amount (NGN)</label>
                                            <input type="number" class="form-control2 text-dark" name="custom_price"
                                                   value="{{ $user->custom_price }}" required>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                Copyright © 2018 Oprime verify. All rights reserved. Dashboard by <a
