...
<div class="fixed z-20 w-full flex flex-col">
    <div class="navbar bg-base-100 border-b">
        <div class="navbar-start">
            ...
            <a href="/"><img src="https://oprime.com.ng/mailer/wp-content/uploads/2024/04/IMG_0359.png" alt="logo" height="50" width="100">
            </a>
        </div>
                    ...
                    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
                        ...
                        <form action="register_now" method="post">
                            ...
                            <div class="form-control mb-4">
                                ...
                                <input type="text" placeholder="username" class="input input-bordered" autofocus
                                       name="username" value="" />
                            </div>
                            ...
                            <div class="form-control mb-4">
                                ...
                                <input type="email" placeholder="email" class="input input-bordered" autofocus
                                       name="email" value="" />
                            </div>
                            ...
                            <div class="form-control mb-4">
                                ...
                                <div class="form-control relative">
                                    <input id="password" type="password" placeholder="password" class="input input-bordered password"
                                           name="password" value="" />

                                    <div id="toggle-password" class="select-none absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
                            ...
                            <div class="form-control mb-4">
                                ...
                                <div class="form-control relative">
                                    <input id="passwords" type="password" placeholder="password" class="input input-bordered password"
                            ...
                            <div class="form-control mb-4">
                                <label class="cursor-pointer label">
                                    <input type="checkbox" class="checkbox checkbox-success" name="tos_accepted" value="yes" required />

                                    <span class="label-text ml-2">
                                    I have read and accept
                                    <a target="_blank" class="link" href="#">Terms of Service</a>
                                    and
...
<script>
    document.getElementById("toggle").addEventListener("click", function () {
        const mustShowPassword = this.classList.toggle('active');
        this.parentElement.querySelector('input').type = mustShowPassword ? 'text' : 'passwords';
    });
